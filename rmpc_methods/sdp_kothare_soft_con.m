...
%
%   Script SDP_KOTHARE_SOFT_CON add the soft constraints into SDP designed
%   by Kothare et al. (1996). 
%   This script extends an original script SDP_KOTHARE, that is required.
%
%   Requires:
